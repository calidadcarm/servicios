...
CREATE TABLE `glpi_plugin_servicios_servicios` (
  ...
  `plugin_servicios_serviciotypes_id` int(11) NOT NULL default '0' COMMENT 'RELATION to glpi_plugin_servicios_serviciotypes (id)',
  ...
  `plugin_servicios_orientados_id` int(11) NOT NULL default '1',
  `groups_id` int(11) NOT NULL default '0',
  `users_id` int(11) NOT NULL default '0',
  `responsable_id` int(11) NOT NULL default '0',
  `titulo` varchar(255) collate utf8_unicode_ci NOT NULL,
  `descripcion` text collate utf8_unicode_ci,
  `garantia` text collate utf8_unicode_ci,
  `cal_id` int(11) NOT NULL default '0',
  `plugin_servicios_criticidads_id` int(11) NOT NULL default '2',
  `acronimosi` varchar(45) collate utf8_unicode_ci default NULL,
  `responsableseguridad_id` int(11) NOT NULL default '0',
  `nusuarios` varchar(45) collate utf8_unicode_ci default NULL,
  `is_afectadoens` tinyint(1) NOT NULL default '0',
  `plugin_servicios_ensnivels_id` int(11) NOT NULL default '0',
  `ens_estado_implantacion` int(11) NOT NULL default '0',
  `autenticationinterno_id` int(11) NOT NULL default '0',
  `autenticationexterno_id` int(11) NOT NULL default '0',
  PRIMARY KEY  (`id`),
  KEY `name` (`name`),
...
CREATE TABLE `glpi_plugin_servicios_servicios_items` (
   `id` int(11) NOT NULL auto_increment,
   `plugin_servicios_servicios_id` int(11) NOT NULL default '0' COMMENT 'RELATION to glpi_plugin_servicios_servicios (id)',
...
INSERT INTO `glpi_displaypreferences` VALUES (NULL,'PluginServiciosServicio','2','2','0');
INSERT INTO `glpi_displaypreferences` VALUES (NULL,'PluginServiciosServicio','3','4','0');
INSERT INTO `glpi_displaypreferences` VALUES (NULL,'PluginServiciosServicio','6','5','0');
INSERT INTO `glpi_displaypreferences` VALUES (NULL,'PluginServiciosServicio','7','6','0');
INSERT INTO `glpi_displaypreferences` VALUES (NULL,'PluginServiciosServicio','8','7','0');
